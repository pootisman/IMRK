...
debug: ${IRMC_DEP} 
	./prep.sh
	mkdir -p .tmp
	gcc -DDEBUG -g -p -std=c99 -Wall -pedantic -O0 -c src/IMRC_gl.c -lglut -lGL -o .tmp/IMRC_gl_dbg.o
	...
	gcc -DDEBUG -g -p -std=c99 -Wall -pedantic -O0 -pthread ${IMRC_DBG_DEP} -lm -lglut -lGL -o bin/IMRC_dbg
clean:
	rm -rfv .tmp
